...
HD_PWD='D:/STUDY/Hardware implementation of CRYSTALS-Dlithium/Kyber/code/BU/BU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log butterfly.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source butterfly.tcl -notrace
