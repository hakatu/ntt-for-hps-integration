...
HD_PWD='D:/STUDY/Hardware implementation of CRYSTALS-Dlithium/Kyber/code/Vivado/wrapKyber/wrapKyber.runs/MULT6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULT6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULT6.tcl
