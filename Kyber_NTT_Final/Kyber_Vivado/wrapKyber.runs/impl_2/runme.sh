...
HD_PWD='D:/STUDY/Hardware implementation of CRYSTALS-Dlithium/Code/Thesis/THESIS FINAL/Hybrid/Kyber_Vivado/wrapKyber.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wrap.tcl -notrace
